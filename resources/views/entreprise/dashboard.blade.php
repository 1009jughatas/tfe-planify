...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <!-- Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Tableau de bord entreprise</h1>
        <p class="mt-2 text-gray-600">
            Bienvenue, {{ auth()->user()->name }} ! 
            @if(auth()->user()->role === 'admin_entreprise')
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $companyProjects->where('status', '!=', 'completed')->count() }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 truncate">Membres de l'équipe</dt>
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 truncate">Tâches assignées</dt>
    ...
    @if(auth()->user()->role === 'admin_entreprise')
        <!-- Actions pour l'admin d'entreprise -->
        <div class="mb-8 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-lg shadow-lg">
            <div class="px-6 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="text-lg font-medium text-white">Administration de l'entreprise</h3>
                        <p class="text-indigo-100">Gérez votre équipe et vos projets d'entreprise</p>
                    </div>
                    <div class="flex space-x-4">
                        <a href="{{ route('entreprise.admin.dashboard') }}" 
                        ...
                        <a href="{{ route('entreprise.admin.users.invite') }}" 
                           class="inline-flex items-center px-4 py-2 border border-white text-sm font-medium rounded-md text-white hover:bg-white hover:bg-opacity-20 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <h2 class="text-lg font-medium text-gray-900">Projets de l'entreprise</h2>
                    @if(auth()->user()->role === 'admin_entreprise')
                        <a href="{{ route('entreprise.admin.projects') }}" class="text-sm text-indigo-600 hover:text-indigo-500">
                            Gérer les projets
                        </a>
                    @endif
                </div>
            ...
            <div class="p-6">
                        ...
                        @foreach($companyProjects->take(5) as $project)
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <a href="{{ route('entreprise.projects.show', $project) }}" class="text-indigo-600 hover:text-indigo-500">
                ...
                @else
                    <div class="text-center py-8">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Votre équipe n'a pas encore créé de projets.</p>
                        @if(auth()->user()->role === 'admin_entreprise')
                            <div class="mt-6">
                                <a href="{{ route('entreprise.admin.projects.create') }}" 
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <h2 class="text-lg font-medium text-gray-900">Mes tâches assignées</h2>
                        ...
                        @foreach($assignedTasks->take(5) as $task)
                            <div class="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <a href="{{ route('entreprise.tasks.show', $task) }}" class="text-indigo-600 hover:text-indigo-500">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                        </svg>
                                    </a>
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                @if(auth()->user()->role === 'admin_entreprise')
                    ...
                    <a href="{{ route('entreprise.admin.users') }}" 
                       class="inline-flex items-center justify-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                        </svg>
                ...
                @else
                    <a href="{{ route('entreprise.projects.index') }}" 
                       class="inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                        </svg>
